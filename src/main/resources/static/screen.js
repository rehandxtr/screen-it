...
(function() {
    ...
    function Signaler(root, roomid) {
        ...
        let userWhoSharedTheScreen = null;
        this.onmessage = function(message) {
            ...
            if (message.roomid == roomid && message.broadcasting && !signaler.sentParticipationRequest)
                ...
                console.debug(JSON.stringify(message, function(key, value) {
                    if(key === "roomid") {
                        if(!value) {
                            let userWhoSharedTheScreenVideo = document.getElementById(userWhoSharedTheScreen);
                            if (userWhoSharedTheScreenVideo && userWhoSharedTheScreenVideo.parentNode) {
                                userWhoSharedTheScreenVideo.parentNode.removeChild(userWhoSharedTheScreenVideo);
                                let againUserWhoSharedTheVideo = document.getElementById(userWhoSharedTheScreen);
                                againUserWhoSharedTheVideo.parentNode.removeChild(againUserWhoSharedTheVideo);

                                /!*removing number of participants*!/
                    ...
                    if(userWhoSharedTheScreen === null) {
                        if (key === "userid") {
                            userWhoSharedTheScreen = value;
                        }
                    }
                    console.log(`in else , ${key} : ${value}`);
                    if (value.sdp) {
...
// Documentation - https://github.com/muaz-khan/WebRTC-Experiment/tree/master/screen-sharing
        ...
        console.log(`Done loading screen.js`);
    },1000);
}
