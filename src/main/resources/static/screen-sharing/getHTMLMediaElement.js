...
function getHTMLMediaElement(mediaElement, config) {
    ...
    mediaElement.style.width = config.width;
    ...
    let mainHeightString = document.getElementById('screen-div').style.height;
    let mainHeight = parseInt(mainHeightString[0])*10 + parseInt(mainHeightString[1]);
    console.log(`mainheightString : ${mainHeightString}, mainHeight: ${mainHeight}`);
    console.log(`value set : ${mainHeight-10}vh`)
    mediaBox.querySelector('video').style.height = mainHeight-10+'vh';
